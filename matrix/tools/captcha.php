...
include_once($_SERVER["DOCUMENT_ROOT"]."/matrix/modules/main/classes/general/captcha.php");
...
require($_SERVER["DOCUMENT_ROOT"]."/matrix/modules/main/include/epilog_after.php");
?>